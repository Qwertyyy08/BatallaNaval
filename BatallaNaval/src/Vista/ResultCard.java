...
public class ResultCard extends javax.swing.JPanel {
    ...
    public ResultCard() {//Constructor
        initComponents();
    }
// -------METODOS PARA EL CONTROLLER -----------------------------------
    // Muestra el resultado final de la partida
    public void setResultado(String texto, boolean victoria) {
        result.setText(texto);
        result.setForeground(victoria
            ? new java.awt.Color(29, 158, 117)   // verde
            : new java.awt.Color(226, 75, 74));   // rojo
    }

    // El controller agrega listener al botón jugar de nuevo
    public javax.swing.JButton getPlayAgainButton() {
        return PlayAgainButton;
    }

    // El controller agrega listener al botón salir
    public javax.swing.JButton getLeaveButton() {
        return LeaveButton;
    }
